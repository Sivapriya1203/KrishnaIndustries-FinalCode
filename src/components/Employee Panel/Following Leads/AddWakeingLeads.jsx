...
//   return (
//     <div>
//         <h1 style={{ textAlign: 'center', marginBottom: '20px' }}>Walking Leads</h1>
    ...
    if (Object.keys(formErrors).length > 0) {
      ...
      axios
        ...
        .then((res) => {
          ...
          // Reset errors and snackbar state
          setErrors({});
  ...
  return (
    <div>
      ...
      <Snackbar
        ...
        anchorOrigin={{ vertical: 'top', horizontal: 'center' }} // Optional: Adjust the position
      >
        <Alert onClose={handleSnackbarClose} severity={snackbarSeverity} sx={{ width: '100%',color:'red' }}>
          {snackbarMessage}
        </Alert>
      </Snackbar>
    </div>
